...
#SBATCH -o /n/home07/swoodward/PM_COVID_ecoinference/RCCluster/test_error.out #specify where to save errors returned by the program
#SBATCH -e /n/home07/swoodward/PM_COVID_ecoinference/RCCluster/test_log.err #specify where to save the output log
#SBATCH --array=1 
...
R CMD BATCH --quiet --no-restore --no-save fit_main.R /n/home07/swoodward/PM_COVID_ecoinference/RCCluster/test_${SLURM_ARRAY_TASK_ID}.Rout
