...
model{
  ...
  pars[1:17] ~ normal(0, sqrt(0.68)); // priors for remaining //corresponds to 95 percent odds ratio between 1/5 and 5
  pars[18] ~ normal(3.196,0.1041);
  pars[19] ~ normal(5.624, 0.1027);
  pars[20] ~ normal(7.589, 0.1026);
  pars[21] ~ normal(-0.2603, 0.1575);
  pars[22:] ~ normal(0, sqrt(0.68));
